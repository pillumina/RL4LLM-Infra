...
本文要拆解的是 Gemma 4 在架构和训练层面做出的每一项技术选择：K=V、p-RoPE、128 小专家 + Dense MLP 双路径、Per-Layer Embeddings——每一项单独看都不算革命性，但叠加在一起，让 31B 参数逼近了 200B+ 级别的性能。
